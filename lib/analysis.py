...
def compute_beta_i(dpar,dfields,dden,vmax,dv,x1,x2,y1,y2,z1,z2):
    ...
    beta_i = (v_ion_th**2./v_ion_a**2.)*(2/np.sqrt(4*np.pi)) #TODO: check this factor on right
...
def compute_beta_i_par(dpar,dfields,dden,vmax,dv,x1,x2,y1,y2,z1,z2):
    ...
    beta_i_par = v_ion_th_par**2./v_ion_a_par**2.*(2/np.sqrt(4*np.pi))
