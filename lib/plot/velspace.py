...
def plot_cor_and_dist_supergrid(vx, vy, vz, vmax,
    ...
    axs[1,0].set_title('$C_E_x(v_x,v_y)$')
    ...
    axs[1,1].set_title('$C_E_x(v_x,v_z)$')
    ...
    axs[1,2].set_title('$C_E_x(v_y,v_z)$')
    ...
    axs[2,0].set_title('$C_E_y(v_x,v_y)$')
    ...
    axs[2,1].set_title('$C_E_y(v_x,v_z)$')
    ...
    axs[2,2].set_title('$C_E_y(v_y,v_z)$')
    ...
    axs[3,0].set_title('$C_E_z(v_x,v_y)$')
    ...
    axs[3,1].set_title('$C_E_y(v_x,v_z)$')
    ...
    axs[3,2].set_title('$C_E_y(v_x,v_y)$')
