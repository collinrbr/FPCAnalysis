...
try:
    ...
    print("This generates FPC netcdf4 file using field fluctuations rather than the total field.")
...
CEx, CEy, CEz, x, Hist, vx, vy, vz = fpc.compute_correlation_over_x(dfieldsfluc, dparticles, vmax, dv, dx, vshock, xlim, ylim, zlim)
