...
pf.make_velsig_gif(vx_in, vy_in, vmax, CEx_in, 'ex', x_in, 'CExFrame'+str(numframe)+'ExB', 'CExFrame'+str(numframe)+'.gif')
pf.make_velsig_gif(vx_in, vy_in, vmax, CEy_in, 'ey', x_in, 'CEyFrame'+str(numframe)+'ExB', 'CEyFrame'+str(numframe)+'.gif')
