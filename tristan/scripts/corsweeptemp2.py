...
pathfpcdata = ''
electotflnm = '/data/backed_up/analysis/collbrown/nonadiaperp/analysisfiles/ncsweeps/elecfacfluclocframe.nc'
...
os.system('mkdir figures/sweeps/elecfacfluclocframe')
...
for _xidx in range(_tempint,len(x_in)):
    ...
    flnm = 'figures/sweeps/elecfacfluclocframe/elecfacfluclocframe_x_'+str("{:07d}".format(_xidx))
