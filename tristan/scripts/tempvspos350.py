...
isprecomputed = False
precomputedflnm = 'analysisfiles/tempvspos_frame350.pickle'#'analysisfiles/tempvspos_short_frame100.pkl' #OOPS Should have been saved to: 'analysisfiles/tempvspos_frame100.pickle'
...
if(not(isprecomputed)):
    ...
    picklefile = 'analysisfiles/tempvspos_frame350.pickle'
...
picklefile = 'analysisfiles/tempvspos_short_frame350.pkl'
with open(picklefile, 'wb') as handle:
...
os.system('mkdir figures/tempvspos_frame350')

flnmprefix = 'figures/tempvspos_frame350/'
