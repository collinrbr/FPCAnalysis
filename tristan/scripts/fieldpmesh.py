...
flnmpmesh = 'figures/pmeshes/nonadiaperppmesh'
print("Making pmesh of total fields...",flpath)
pmeshsuperplot(dfields,dflow,flnmpmesh,btot0,etot0,xlim0=5,xlim1=12,usetotallabels=True)

dfluc = aa.remove_average_fields_over_yz(dfields)
flnmpmesh = 'figures/pmeshes/nonadiaperppmeshdfluc'
print("Making pmesh of fluc fields (shock rest frame)...",flpath)
pmeshsuperplot(dfluc,dflow,flnmpmesh,btot0,etot0,xlim0=5,xlim1=12,usetotallabels=False)
